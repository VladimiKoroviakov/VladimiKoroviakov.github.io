...
const translations = {
    en: {
		...
		myStory: "As a proficient web developer, I help companies and individuals make a bold statement in the digital world. Using the most advanced technologies such as HTML5, CSS3, JavaScript, React, Tailwind CSS, Gulp, WordPress, and an AI stack (Claude, GPT, Gemini, DeepSeek). I develop websites that are not only visually striking, but also extremely functional, intuitive, and user-friendly. Whether you're an entrepreneur looking to promote your brand or an individual dreaming of a personalised online space, I create customised solutions that meet your goals. Let's join forces to bring your wildest ideas to life and create an online presence that captivates and inspires!",
        ...
        faculty: "Computer Science Degree (2022-2026)",
        universityDescr: "Built a solid foundation in algorithms, software engineering, and problem-solving, laying the groundwork for a hands-on career in web development.",
        ...
        aiStack: "Leverages Claude, GPT, Gemini, and DeepSeek together to write code faster, catch issues early, and explore new ideas along the way.",
        react: "A component-based JavaScript library for building fast, interactive user interfaces with reusable, maintainable code.",
        tailwind: "A utility-first CSS framework that makes it possible to build fully custom designs quickly, without leaving the HTML.",
        gulp: "Is a task execution program. It helps to run external tasks and large scale web applications.",
        postgresql: "A powerful open-source relational database known for reliability, extensibility, and strong support for complex queries.",
        nextjs: "A React framework for building fast, SEO-friendly websites and apps with server-side rendering and routing built in.",
        nodejs: "A JavaScript runtime that lets me build fast, scalable backends and APIs using the same language as the frontend.",
        framer: "A design and prototyping tool that lets me build and publish polished, interactive websites without heavy custom code.",
    ...
    pl: {
        ...
        faculty: "Kierunek Informatyka (2022-2026)",
        universityDescr: "Zdobyłem solidne podstawy w zakresie algorytmów, inżynierii oprogramowania i rozwiązywania problemów, które stały się fundamentem mojej praktycznej kariery w tworzeniu stron internetowych.",
        ...
        aiStack: "Łączy Claude, GPT, Gemini i DeepSeek, aby pisać kod szybciej, szybciej wychwytywać błędy i odkrywać nowe pomysły w trakcie pracy.",
        react: "Oparta na komponentach biblioteka JavaScript do budowania szybkich, interaktywnych interfejsów użytkownika z użyciem wielokrotnie wykorzystywalnego kodu.",
        tailwind: "Framework CSS typu utility-first, który pozwala szybko tworzyć w pełni niestandardowe projekty bez opuszczania kodu HTML.",
        gulp: "Program do wykonywania zadań. Pomaga uruchamiać zadania zewnętrzne i aplikacje internetowe na dużą skalę.",
        postgresql: "Potężna baza danych typu open source, znana z niezawodności, rozszerzalności i doskonałej obsługi złożonych zapytań.",
        nextjs: "Framework React do budowania szybkich, przyjaznych dla SEO stron i aplikacji z wbudowanym renderowaniem po stronie serwera i routingiem.",
        nodejs: "Środowisko uruchomieniowe JavaScript, które pozwala tworzyć szybkie, skalowalne backendy i API w tym samym języku co frontend.",
        framer: "Narzędzie do projektowania i prototypowania, które pozwala budować i publikować dopracowane, interaktywne strony bez dużej ilości niestandardowego kodu.",
    ...
    ua: {
		...
		myStory: "Як професійний веброзробник, я допомагаю компаніям і приватним особам  сміливо заявляти про себе в цифровому світі. Використовуючи найсучасніші технології, такі як HTML5, CSS3, JavaScript, React, Tailwind CSS, Gulp, WordPress та стек AI-інструментів (Claude, GPT, Gemini, DeepSeek) я розробляю вебсайти, які не лише вражають візуально, але є надзвичайно функціональними, інтуїтивно зрозумілими та зручними. Незалежно від того, чи ви підприємець, який прагне просувати свій бренд, чи приватна особа, яка мріє про персоналізований онлайн-простір, я допоможу Вам створити індивідуальне рішення, яке відповідатиме вашим цілям. Об'єднаймо зусилля, аби втілити Ваші найсміливіші ідеї в життя і створити онлайн-платформу, яка зачаровує і надихає!",
		...
		skillDescr3: "Майстерно поєдную творчість з функціональністю, спеціалізую-<br>чись на створенні інтуїтивно зро-<br>зумілих інтерфейсів і захоплю-<br>ючого користувацького досвіду.",
		experience: "Досвід",
		background: "Моя історія",
        education: "Освіта",
        university: "СумДУ",
        faculty: "Спеціальність «Комп’ютерні науки» (2022-2026)",
        universityDescr: "Здобув міцну базу з алгоритмів, інженерії програмного забезпечення та розв’язання задач, що заклала фундамент для практичної кар’єри у веброзробці.",
        ...
        aiStack: "Поєдную Claude, GPT, Gemini та DeepSeek, щоб швидше писати код, вчасно знаходити помилки та досліджувати нові ідеї в процесі роботи.",
        react: "Бібліотека JavaScript на основі компонентів для створення швидких, інтерактивних інтерфейсів користувача з багаторазовим кодом.",
        tailwind: "CSS-фреймворк у стилі utility-first, який дозволяє швидко створювати повністю кастомні дизайни, не виходячи з HTML.",
        gulp: "Програма для виконання завдань. Вона допомагає запускати зовнішні завдання та масштабні вебдодатки.",
        postgresql: "Потужна база даних з відкритим кодом, відома надійністю, розширюваністю та підтримкою складних запитів.",
        nextjs: "Фреймворк на основі React для створення швидких, SEO-дружніх сайтів і застосунків із вбудованим серверним рендерингом і маршрутизацією.",
        nodejs: "Середовище виконання JavaScript, яке дозволяє створювати швидкі, масштабовані бекенди та API тією ж мовою, що й фронтенд.",
        framer: "Інструмент для дизайну та прототипування, що дозволяє створювати й публікувати відточені, інтерактивні сайти без великої кількості власного коду.",
