...
var forms = function forms(state) {
  ...
  var message = {
    loading: 'Loading...',
    success: 'Thank you for reaching out! We will contact you shortly',
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var previousModal = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
    var trigger = document.querySelectorAll(triggerSelector),
        modal = document.querySelector(modalSelector),
        close = document.querySelector(closeSelector),
        windows = document.querySelectorAll('[data-modal]'),
        prevModal = document.querySelector(previousModal),
        scroll = calcScroll();
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        // Problem: they are not bound with each other in any way 
        // the current button opens the next modal window 

        if (triggerSelector === '.popup_calc_button' && prevModal) {
          var widthInput = prevModal.querySelector('#width');
          var heightInput = prevModal.querySelector('#height');

          var checkInput = function checkInput(input) {
            if (input.value === '' || input.value === '0' || input.value.length < 3) {
              input.style.border = '1px solid red';
              input.setCustomValidity('Please, fill in this field (min 2 digits)');
              input.reportValidity();
            }
          };

          var clearInputError = function clearInputError(input) {
          ...
          if (widthInput.value === '' || heightInput.value === '' || widthInput.value === '0' || heightInput.value === '0' || widthInput.value.length < 2 || heightInput.value.length < 2) {
        ...
        if (triggerSelector === '.popup_calc_profile_button' && prevModal) {
          var checkboxes = prevModal.querySelectorAll('.checkbox');
  ...
  bindModal('.popup_calc_button', '.popup_calc_profile', '.popup_calc_profile_close', false, '.popup_calc');
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false, '.popup_calc_profile');
};
